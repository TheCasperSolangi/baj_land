      ...
      <div className="container py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-1">
            <img src={bajgoLogo} alt="BajGo" className="h-16 w-16 rounded-xl mb-4" />
            <p className="text-sm text-background/50 mb-5">
              Your one-stop delivery platform powered by Lalamove.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2">
                <MapPin className="h-4 w-4 text-primary" /> Manila, Philippines
              </li>
              <li className="flex items-center gap-2">
                <Phone className="h-4 w-4 text-primary" /> +63 912 345 6789
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-primary" /> hello@bajgo.ph
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-background/10 mt-12 pt-8 text-center text-sm text-background/40">
          © {new Date().getFullYear()} BajGo. All rights reserved.
        </div>
      </div>
    </footer>
  );
